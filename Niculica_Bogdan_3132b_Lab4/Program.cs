...
namespace Niculica_Bogdan_3132b_Lab4
{
    class CubWindow : GameWindow
    {
        ...
        // Constructor.
        public CubWindow(string fileName = "getcub.txt") : base(800, 600)
        {
            VSync = VSyncMode.On;
            cub = new Cube(fileName);
        }
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            Matrix4 lookat = Matrix4.LookAt(5, 30, 15, 0, 0, 0, 0, 1, 0);
        ...
        static void Main(string[] args)
        {
            ...
            /**Utilizarea cuvântului-cheie "using" va permite dealocarea memoriei o dată ce obiectul nu mai este
               ...
               în final pe ecran). */
            using (CubWindow example = new CubWindow("cub.txt"))
            {
