...
namespace Laborator5Tema
{
    ...
    class Window3D : GameWindow
    {
        ...
        private List<CubeDown> spawnareCuburi;
        ...
        public Window3D() : base(1280, 768, new GraphicsMode(32, 24, 0, 8))
        {
            ...
            spawnareCuburi = new List<CubeDown>();
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            {
                //ex3-loading obj object
                copac = new MassiveObject(Color.DarkGreen);
            }
            ...
            //Rezolvare Laborator 5 - generarea obiectelor ce se deplaseaza in jos
            if (currentMouse[MouseButton.Left] && !previousMouse[MouseButton.Left])
            {
                spawnareCuburi.Add(new CubeDown());
            }
            //cerinta 2 - repozitionarea camerei
            ...
            foreach (CubeDown obj in spawnareCuburi)
            {
                obj.UpdatePosition();
            }
        ...
        private void DisplayHelp()
        {
            ...
            Console.WriteLine(" (L) - incarcare obiect 3D");
        }
